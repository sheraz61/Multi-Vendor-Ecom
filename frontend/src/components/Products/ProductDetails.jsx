                            ...
                            <div className='w-full 800px:w-[50%]'>
                                ...
                                <div className='w-full flex'>
                                    <div className={`${select === 0 ? "border" : "null"} cursor-pointer`}>
                                        <img src={data?.image_Url[0].url} alt="" className='h-[200px]'
                                            onClick={() => setSelect(0)}
                                        />
                                    </div>
                                    <div className={`${select === 1 ? "border" : "null"} cursor-pointer`}>
                                        <img src={data?.image_Url[1].url} alt="" className='h-[200px]'
                                            onClick={() => setSelect(1)}
                                        />
                                    </div>
                                </div>
            ...
            {active === 3 ? (
                <div className='w-full block 800px:flex p-5'>
                    <div className='w-full 800px:w-[50%]'>
                        ...
                        <p className='pt-2'>
                            Lorem ipsum, dolor sit amet consectetur adipisicing elit. In odio voluptatibus vel ipsa sit odit, inventore, corporis vero quae veniam autem doloribus eum iure vitae, sequi labore quibusdam tenetur incidunt.
                        </p>
                    </div>
